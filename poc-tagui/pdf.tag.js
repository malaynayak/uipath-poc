...
var flow_path = '/Users/malay.nayak/Documents/tagui/poc';
...
casper.then(function() {{techo('dclick im.png using ocr'); var fs = require('fs');
if (!sikuli_step('dclick im.png using ocr')) if (!fs.exists('im.png using ocr') && !true)
{this.echo('ERROR - cannot find image file im.png using ocr').exit(); this.wait(0);} else
{sikuli_step('snap page.png to /Users/malay.nayak/Documents/tagui/poc/pdf_error.png');
this.echo('ERROR - cannot find im.png using ocr on screen').exit(); this.wait(0);}}});

casper.then(function() {techo('wait 30');});
casper.then(function() {casper.wait(30000, function() {});});

casper.then(function() {{techo('keyboard [ctrl]a'); var fs = require('fs');
if (!sikuli_step('keyboard [ctrl]a')) if (!fs.exists('[ctrl]a') && !false)
{this.echo('ERROR - cannot find image file [ctrl]a').exit(); this.wait(0);} else
{sikuli_step('snap page.png to /Users/malay.nayak/Documents/tagui/poc/pdf_error.png');
this.echo('ERROR - cannot find [ctrl]a on screen').exit(); this.wait(0);}}});

casper.then(function() {{techo('keyboard [ctrl]c'); var fs = require('fs');
if (!sikuli_step('keyboard [ctrl]c')) if (!fs.exists('[ctrl]c') && !false)
{this.echo('ERROR - cannot find image file [ctrl]c').exit(); this.wait(0);} else
{sikuli_step('snap page.png to /Users/malay.nayak/Documents/tagui/poc/pdf_error.png');
...
casper.then(function() {this.echo(''+text_contents+'');});
